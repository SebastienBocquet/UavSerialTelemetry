...
def test_missing_key():
    ...
    print('value', displayedValue[0])
    assert np.isnan(displayedValue[0])
...
def test_count_packets2():
    ...
    subLine1 = b'key1:0.1;key2:2.;end\n'
...
def test_clear_line():
    ...
    assert line.nbPackets == 0 and line.str == ''
